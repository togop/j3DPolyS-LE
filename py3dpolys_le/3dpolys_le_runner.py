...
# p.add_argument("-ca", "--count_amplifier", default=100, help="HiC count amplifier. Default: 100 = Niter", type=int)
...
class DccExtrusionArgs:
    ...
    def __init__(self, stats=False, all_stats=False, boundary="", lef_binding_sites="", input_cfg="./input.cfg",
                 ...
                 init_mode='m',
                 output_folder='', analyse='', simultaneously=1, cmp_chrs=None):
...
class DccExtrusionRunner:
    ...
    @staticmethod
    def chip_seq_plots(dcc_args: DccExtrusionArgs, bin_size, correlation=ha.DEFAULT_CHIP_CORRELATION, replace=True):
        sim_stats_pd = DccExtrusionRunner.read_stats_file(dcc_args.stats_file)
